            ...
            <div className="main-product-details">
              ...
              <div className=" py-3">
                ...
                <div className="d-flex gap-10 align-items-center my-2">
                  ...
                  <p className="product-data"> watch imported</p>
                </div>
                <div className="d-flex gap-10 align-items-center my-2">
                  ...
                  <p
                    className={
                      2 < 1
                        ? "product-data redColor"
                        : "product-data greenColor"
                    }
                  >
                    {2 < 1 ? "Out Of Stock" : "InStock"}
                  </p>
                </div>
        ...
        <div className="row">
          <div className="col-12">
            ...
            <div className="bg-white p-3">
              <p>
                Watch back light effect in dark, 5ATM water proof, Foreseeing
                the weather in 24 hours, Relative Altitude, Barometer (air
                pressure trend chart), Compass, Temperature, Steps track, Pacer,
                Dual Time, 2 sets of alarm
              </p>
            </div>
          </div>
        </div>
